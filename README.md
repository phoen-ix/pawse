...
`makensis` lines CI runs - see [`packaging/README.md`](packaging/README.md). The
Microsoft Store package (MSIX, no built-in updater) has its own build script and notes in
