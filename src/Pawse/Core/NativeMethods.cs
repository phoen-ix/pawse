...
internal static class NativeMethods
{
    ...
    // takes mouse input while every keystroke goes somewhere else. App.ForceForeground asks
    // once more directly; see the note there on why it does NOT use AttachThreadInput.
    [DllImport("user32.dll", SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
